...
<?php include '../component/jumbotron.php'; ?>
    ...
    <body>
        ...
        <?= jumbotron_fluido(['titulo' => 'LP I - 2023/1', 'subtitulo' => 'Aprendendo PHP do zero!']) ?>

        <form class="text-center border border-light p-5" action="http://localhost/lp12/aula02/display.php">
